...
public class LocalizationService
{
    ...
    private static readonly Dictionary<string, Dictionary<string, string>> Strings = new()
    {
        ["ar"] = new()
        {
            ...
            ["refresh"]             = "تحديث",
            ["vol_send_request"]    = "إرسال طلب الانضمام",
            ["vol_success_title"]   = "تم استلام طلبك بنجاح!",
            ["vol_success_msg"]     = "سيتم التواصل معك عبر الواتساب أو هاتفياً لتحديد موعد للانضمام.",
            ["vol_back_home"]       = "العودة للرئيسية",
        },
        ["fr"] = new()
        {
            ...
            ["refresh"]             = "Actualiser",
            ["vol_send_request"]    = "Envoyer ma candidature",
            ["vol_success_title"]   = "Votre demande a été reçue !",
            ["vol_success_msg"]     = "Nous vous contacterons via WhatsApp ou par téléphone pour fixer un rendez-vous.",
            ["vol_back_home"]       = "Retour à l'accueil",
        },
        ["en"] = new()
        {
            ...
            ["refresh"]             = "Refresh",
            ["vol_send_request"]    = "Submit Application",
            ["vol_success_title"]   = "Your application has been received!",
            ["vol_success_msg"]     = "We will contact you via WhatsApp or phone to schedule your joining appointment.",
