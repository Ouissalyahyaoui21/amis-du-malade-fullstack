...
public partial class VolunteerRegisterViewModel : BaseViewModel
{
    ...
    {
        // بلديات ولاية سكيكدة الـ 38 (المصدر: الإحصائيات الرسمية للجمهورية الجزائرية)
        "سكيكدة", "عزابة", "القل", "الحروش", "تمالوس", "أم الطوب",
        "رمضان جمال", "فيلفيلة", "حمادي كرومة", "بن عزوز", "بكوش لخضر",
        "سيدي مزغيش", "الحدائق", "القنواع", "بين الويدان", "عين شرشار",
        "بني بشير", "كركرة", "عين قشرة", "بني زيد", "بني ولبان",
        "زيتونة", "أولاد أحبابة", "الشرايع", "وادي الزهور", "أولاد عطية",
        "خناق مايوم", "أمجاز الدشيش", "صالح بوالشعور", "جندل",
        "الولجة بوالبلوط", "السبت", "الغدير", "المرسى", "عين بوزيان",
        "عين زويت", "بوشطاطة", "زردازة",
    };
